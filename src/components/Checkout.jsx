      ...
      <div className="min-w-[1000px] max-w-[1500px] m-auto pt-8" >
        <div className="grid grid-cols-8 gap-10" >
                        ...
                        <div className="col-span-10 grid grid-cols-8 divide-y divide-gray-400">
                          <div className="col-span-2">
                            <Link to={`/product/${product.id}`}>
                              <img className="p-4 m-auto" src={product.image_small} alt='product img' />
                            </Link>
                          </div>
                          <div className="col-span-6">
                            ...
                            <div className="grid grid-cols-3 w-20 text-center">
                              ...
                              <div className="text-xl xl:text-xl bg-gray-200">{product.quantity}</div>
                              <div className="text-xl xl:text-2xl bg-gray-400 rounded">+</div>
                            </div>
          ...
          <div className="col-span-2 bg-white rounded h-[250px] p-7">
              ...
              <div className="text-base xl:text-lg mb-4">Subtotal ({itemsNumber} items):  
              <span className="font-semibold"> {GB_CURRENCY.format(subtotal)}</span></div>
